Spree::Variant.class_eval do
    ...
    belongs_to :greeting, touch: true, class_name: 'Spree::Greeting', inverse_of: :variants
    ...
    def set_option_value(opt_name, opt_value)
      ...
      unless current_value.nil?
        ...
        unless self.greeting.option_types.include? option_type
