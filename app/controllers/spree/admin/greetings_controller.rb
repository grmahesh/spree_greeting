class Spree::Admin::GreetingsController < Spree::Admin::ResourceController
      ...
      def destroy
		  @greeting = Spree::Greeting.friendly.find(params[:id])
      ...
      def find_resource
		  Spree::Greeting.with_deleted.friendly.find(params[:id])
      end
